...
for (var i = 0; i < 9; i++) {
    ...
    divImg1.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${ageNames[counter]}.png`)
    divImg1.id = cardId[counter]
    counter += 1
    divImg2.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${ageNames[counter]}.png`)
...
document.getElementById("power").onclick = function() {
    ...
    for (var i = 0; i < 9; i++) {
        ...
        divImg1.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${powerNames[counter]}.png`)
        divImg1.id = cardId[counter]
        counter += 1
        divImg2.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${powerNames[counter]}.png`)
        divImg2.id = cardId[counter]
        counter += 1
...
document.getElementById("magic-level").onclick = function() {
    ...
    for (var i = 0; i < 9; i++) {
        ...
        divImg1.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${magicLevelNames[counter]}.png`)
        divImg1.id = cardId[counter]
        counter += 1
        divImg2.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${magicLevelNames[counter]}.png`)
        divImg2.id= cardId[counter]
        counter += 1
...
document.getElementById("fright-factor").onclick = function() {
    ...
    for (var i = 0; i < 9; i++) {
        ...
        divImg1.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${frightFactorNames[counter]}.png`)
        divImg1.id = cardId[counter]
        counter += 1
        divImg2.setAttribute("src", `https://github.com/LyshaJaufar/BeastBattle/blob/master/assets/${frightFactorNames[counter]}.png`)
        divImg2.id = cardId[counter]
        counter += 1
